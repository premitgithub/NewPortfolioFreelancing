import { Project, Skill, Experience, Achievement, Certification } from './components/types';
...
export const PROJECTS: Project[] = [
  {
    ...
    description: 'A scalable MERN-stack grocery management platform supporting customers, shopkeepers, and delivery partners with secure authentication, AI-powered automation, and real-time communication.',
    image: 'https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&q=80&w=2000',
    tags: ['React.js', 'Node.js', 'MongoDB', 'Express.js', 'Firebase', 'Gemini API'],
  ...
  },
  {
    ...
    description: 'A robust backend-driven bookstore management platform with layered architecture, optimized database handling, and secure REST API integrations.',
  ...
  },
  {
    ...
    description: 'A high-performance booking platform focused on scalable backend integration, secure authentication workflows, and cross-platform responsive excellence.',
...
export const CERTIFICATIONS: Certification[] = [
  { title: 'Developing Back-End Apps with Node.js and Express', issuer: 'IBM', link: 'https://drive.google.com/file/d/1aSzLSnUaQoOyk6_vV-dAddkug6o9FVsQ/view' },
  { title: 'Getting Started with Git and GitHub', issuer: 'IBM', link: 'https://drive.google.com/file/d/1V8_Mdf7S-_dm0VgvNKdZkh7QGV3QF0z1/view' },
  { title: 'Data Structures and Algorithms with Java', issuer: 'NPTEL', link: 'https://drive.google.com/file/d/1X_IZ-uUP5wCZ7_vwfUTJ16gucI3vk-0p/view' },
  { title: 'Object Oriented Programming in Java', issuer: 'Coursera', link:'https://drive.google.com/file/d/1u8f4kuSF4jrwmzgd29q6WC7IcSx_o1hc/view' }
];

...
export default function About() {
  return (
    <section id="about" className="py-20 md:py-32 px-6 md:px-12 bg-charcoal relative overflow-hidden">
        ...
        <div className="lg:w-1/2">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-display font-bold leading-tight mb-8">
              Scalable <span className="italic">Solutions</span> for <span className="text-soft-silver">Modern Businesses</span>.
            </h2>
            <div className="space-y-6 text-soft-white/70 text-lg leading-relaxed max-w-xl font-sans">
              <p>
                I am a Full Stack Developer specialized in helping startups and established businesses build robust, scalable, and high-performance web applications. My focus is on creating value through clean architecture, real-time capabilities, and efficient backend systems.
              </p>
              <p>
                With a deep understanding of MERN Stack, Spring Boot, and Enterprise-grade API engineering, I bridge the gap between complex business requirements and production-ready software solutions.
              </p>
            </div>
            ...
            <div className="mt-16 grid grid-cols-2 lg:grid-cols-3 gap-12">
              {ACHIEVEMENTS.map((stat, index) => (
                <div key={index} className="flex flex-col">
                  <span className="text-5xl font-display font-bold text-soft-white mb-2">{stat.value}</span>
                  <span className="text-[10px] uppercase tracking-widest font-bold text-soft-white/40">{stat.label}</span>
                </div>
              ))}
            </div>
          </motion.div>

...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      className="py-20 md:py-32 px-6 md:px-12 bg-matte-black"
    >
                    ...
                    {project.metrics && (
                      <div className="flex flex-wrap gap-2">
                        {project.metrics.map((m, i) => (
                          <span
                            key={i}
                            className="text-[8px] uppercase tracking-widest font-bold px-2 py-1 bg-electric-blue/20 text-white border border-electric-blue/30 rounded-full"
                          >
                            {m}
                          </span>
                        ))}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-4">
                    {project.tags.map((tag) => (
                      <span
                        key={tag}
                        className="text-[9px] uppercase tracking-widest font-bold px-2 py-1 bg-charcoal text-soft-white/40 border border-soft-white/5 rounded-full"
                      >
                        {tag}
                      </span>
                    ))}
